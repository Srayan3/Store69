...
<html lang="en" dir="ltr">
   ...
   <body>
      ...
      <div id="login-failed" style="display: block;" class="alert alert-success" role="alert">
        Account successfully registered, you can login now
      </div>
         <div class="text">
            SIGN UP
         </div>
         <img style="width: 100%" src="./img/smilie.svg" alt="">
            <div class="link">
               Click here to continue to 
               <a style="color: rgb(30, 148, 255); cursor: pointer;" onclick="signup()">Home <span class="fas fa-arrow-right"></span></a>
            </div>
      </div>
      <script>
        function signup(){
